...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/users/{id}", "/api/advert-service/adverts", "/api/advert-service/adverts-latest", "/api/advert-service/adverts/{id}", "/api/advert-service/adverts/users/{id}").permitAll()
